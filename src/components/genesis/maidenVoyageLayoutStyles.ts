...
/** Primary card surface — subtle lift above page bg #1E4775. */
export const MV_CARD_SHELL =
  "rounded-2xl border border-white/12 bg-[#244a72]/90 shadow-[0_4px_24px_-12px_rgba(0,0,0,0.35)]";
...
export const MV_STATS_BAND =
  "border-y border-white/10 bg-[#244a72]/60";

export const MV_FOOTER_PANEL = "border-t border-white/10 bg-white/[0.04]";
...
export const MV_OUTLINE_BUTTON =
  "inline-flex items-center gap-1.5 rounded-full border border-white/25 bg-white/[0.04] px-4 py-2 text-sm font-semibold text-white/90 transition hover:border-white/40 hover:bg-white/[0.08]";
...
export const MV_ICON_BADGE =
  "flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#FF8A7A]/30 bg-[#FF8A7A]/10 text-[#FF8A7A]";

export const MV_ICON_BADGE_LG =
  "flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[#FF8A7A]/30 bg-[#FF8A7A]/10 text-[#FF8A7A]";

export const MV_DETAILS_PANEL =
  "rounded-xl border border-white/12 bg-[#244a72]/90";

export const MV_COUNTDOWN_PANEL =
  "rounded-lg border border-[#FF8A7A]/20 bg-[#FF8A7A]/10";
...
export const MV_TABLE_ROW =
  "grid grid-cols-1 gap-3 rounded-xl border border-white/12 bg-[#244a72]/90 px-3 py-3 md:items-center md:gap-3 md:py-2.5";

export const MV_EXPLORER_TABS =
  "inline-flex rounded-full border border-white/12 bg-white/[0.06] p-0.5";
