...
export default function MarketSelector({
 ...
 {/* Dropdown Menu */}
 <div
 className={`absolute z-10 mt-2 w-[300px] origin-top-left left-0 bg-gray-900 border border-gray-700 shadow-xl focus:outline-none transition-all duration-300 ease-in-out ${
 isOpen
