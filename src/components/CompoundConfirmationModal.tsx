...
const FeeBadge = ({ fee }: { fee: FeeInfo }) => (
  <div className="flex items-center gap-1.5 px-2 py-0.5 bg-amber-100 border border-amber-300 rounded text-[10px] text-amber-800 font-medium whitespace-nowrap">
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-white shadow-2xl w-full max-w-md mx-4 animate-in fade-in-0 scale-in-95 duration-200 rounded-lg max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-1">
            {steps.map((step, index) => {
              ...
              return (
                <div
                  key={step.id}
                  className={`border border-[#1E4775]/15 rounded-lg overflow-hidden transition-all ${
                ...
                >
                  ...
                  {isExpanded && hasDetails && (
                    <div className="px-3 pb-2 pt-0 border-t border-[#1E4775]/10 bg-[#1E4775]/[0.02]">
                      ...
                      {stepFee && (
                        <div className="mt-2 ml-9 p-2 bg-amber-50 border border-amber-200 rounded text-[11px]">
