...
export const CompoundTargetTokenModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[65] flex items-center justify-center">
      ...
      <div className="relative bg-white/88 backdrop-blur-lg backdrop-saturate-150 border border-[#1E4775]/20 shadow-2xl shadow-black/10 w-full max-w-3xl mx-2 sm:mx-4 animate-in fade-in-0 scale-in-95 duration-200 flex flex-col max-h-[95vh] sm:max-h-[90vh] rounded-none overflow-hidden">
