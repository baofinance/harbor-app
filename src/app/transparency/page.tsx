    ...
    <span className="text-[#1E4775] font-semibold text-[10px] w-12">
     Yield
                                                        ...
                                                        {categories.map((category) => {
                                                            ...
                                                            return (
                                                                <div key={category.name}
                                                                     className="bg-[#1E4775]/5 p-1.5 text-center">
                                                                    <div
            ...
            yield ⟶
                                                    ...
                                                    {/* Bar container */}
                                                    <div
                                                        className="relative h-4 bg-[#1E4775]/10 rounded overflow-visible">
                                                        {/* Bar segments */}
        ...
        <div className="flex flex-col gap-1 py-1.5 px-2 bg-[#1E4775]/5 text-center">
            ...
            <div className="flex items-center justify-center gap-1.5">
                <button onClick={handleCopy}>
                    <code className="font-mono text-[10px]">{truncated}</code>
                </button>
                        ...
                        <>
                            {finishedMarkets.length > 0 && (
                                <div className="hidden lg:block bg-white p-2 mb-2">
                                    <div
                                        className="grid grid-cols-[1.3fr_1fr_1fr_1fr_1fr_1fr_1fr_auto] gap-4 items-center uppercase tracking-wider text-[10px] text-[#1E4775] font-bold">
