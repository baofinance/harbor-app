...
export function SailMarketsTableHeader() {
  return (
    <div className="hidden md:block bg-white py-1.5 px-2 overflow-x-auto mb-2 rounded-md border border-[#1E4775]/15 shadow-sm">
      <div className="grid grid-cols-[32px_1.8fr_1fr_0.88fr_1fr_1fr_1.12fr_0.8fr] gap-4 items-center uppercase tracking-wider text-[10px] lg:text-[11px] text-[#1E4775] font-semibold">
