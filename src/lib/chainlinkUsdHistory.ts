...
export const CHAINLINK_USD_FEED_BY_ASSET: Record<
  PegAssetKey,
  `0x${string}` | null
> = {
...
export function isChainlinkUsdHistoryAsset(
  asset: string | null | undefined,
): asset is PegAssetKey {
  return (
    asset === "ETH" ||
    asset === "BTC" ||
    asset === "EUR" ||
...
export async function fetchChainlinkUsdHistory(
  ...
  const feedAddress = CHAINLINK_USD_FEED_BY_ASSET[asset];
