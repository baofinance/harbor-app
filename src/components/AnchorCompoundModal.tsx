      ...
      <div className="relative bg-white shadow-2xl w-full max-w-md mx-4 animate-in fade-in-0 scale-in-95 duration-200">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="p-4 bg-[#17395F]/10 border border-[#17395F]/20 rounded">
          ...
          <div className="space-y-2">
            ...
            <div className="p-4 bg-[#B8EBD5]/30 border border-[#B8EBD5]/50 rounded">
              <div className="flex justify-between items-center">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                {fees.map((fee, index) => (
                  <div
                    key={index}
                    className="p-3 bg-[#FF8A7A]/10 border border-[#FF8A7A]/20 rounded"
                  >
                    <div className="flex justify-between items-center">
