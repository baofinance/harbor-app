...
export type IndexMarksSubgraphErrorBannerProps = {
  error?: Error | unknown;
};

/**
 * Harbor Marks subgraph failure banner (Anchor extended layout, Sail extended layout).
 */
export function IndexMarksSubgraphErrorBanner({
  error,
}: IndexMarksSubgraphErrorBannerProps) {
  return (
