...
/** Primary card surface — darker than page bg #1E4775 for readable white text. */
export const MV_CARD_SHELL =
  "rounded-2xl border border-white/10 bg-[#0f2340] shadow-[0_0_40px_-16px_rgba(0,0,0,0.5)]";
...
export const MV_STATS_BAND =
  "border-y border-white/10 bg-[#0c1e36]";

export const MV_FOOTER_PANEL = "border-t border-white/10 bg-black/15";
...
export const MV_PROGRESS_TRACK =
  "h-4 overflow-hidden rounded-full border border-white/10 bg-black/30";
...
export const MV_OUTLINE_BUTTON =
  "inline-flex items-center gap-1.5 rounded-full border border-white/25 bg-transparent px-4 py-2 text-sm font-semibold text-white/90 transition hover:border-white/40 hover:bg-black/20";
