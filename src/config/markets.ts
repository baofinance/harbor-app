...
export const markets = {
  ...
  // MegaETH genesis (`btc-usd-megaeth`, `wsteth-usd-megaeth`, chainId 4326): not
  // launching yet. To ship: restore the spread merged from staging (conditional on
  // `contractsMarkets["btc-usd-megaeth"]`), with a small `getContractMarket` helper
  // gate if desired; ensure `NEXT_PUBLIC_USE_MEGAETH` / contract typings include SPM.
} as const;
