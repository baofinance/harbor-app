...
**UI modules:** [`src/components/sail/`](../../src/components/sail/) — stats banner, **`SailAdvancedLayout`** ([`advanced/`](../../src/components/sail/advanced/)), basic cards grid (UI−), archived section. Barrel: [`index.ts`](../../src/components/sail/index.ts).
