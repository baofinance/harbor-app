...
interface EtherscanLinkProps {
  label: string;
  address?: string;
  /** Chain ID for the contract; defaults to 1 (mainnet). */
  chainId?: number | null;
  className?: string;
  showLabel?: boolean;
}
...
/**
 * Reusable component for contract address links. Uses the correct block explorer
 * for the given chain (Etherscan, Arbiscan, Basescan, Mega Etherscan, Monadscan, etc.).
 */
export function EtherscanLink({
  ...
  const href = getBlockExplorerAddressUrl(address, chainId);
