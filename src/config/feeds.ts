...
export const feeds = {
    mainnet: {
        fxUSD: [
            ...
            { label: "fxUSD/XAU", address: "0x4be4501336130E61e5872cB953e886a3a84D34Cc" as const, status: "available" as const },
            { label: "fxUSD/MCAP", address: "0x63d961913cd855f5f8C8cA7cDC22771abA3326FE" as const, status: "available" as const },
            { label: "fxUSD/XAG", address: "0xD59a1c8D1fa8f3FAE1E1f835E243A7BFb6173f91" as const, status: "available" as const },
        ],
        ...
        stETH: [
            ...
            { label: "stETH/XAU", address: "0x863C1185470b3D2d3E9D5FbB82e7837de081F46c" as const, status: "available" as const },
            { label: "stETH/MCAP", address: "0x6B5A6950f7f2b380c33aF81dbbD7DA31caaFEA63" as const, status: "available" as const },
            { label: "stETH/XAG", address: "0xE0Ba50991B891df0f0F92d06127B43314a5e427d" as const, status: "available" as const },
        ],
        USDE: [],
    },
